...
function InitiateSideMenu() {
    ...
    $("#sidebar-collapse").on("click", function () {
        ...
        $('#MenuSideBig').toggleClass('dis-none');
        $('#MenuSideSmall').toggleClass('dis-none');
        $(".sidebar-collapse").toggleClass("active");
        n = $("#sidebar").hasClass("menu-compact");
        n && $(".open > .submenu").removeClass("open");
        $('.MainLeft').toggleClass('CgW');
        $('.page-content').toggleClass('backsize');
        ...
        setTimeout(function () {
            ...
            //if ($("#PayS_chart").length > 0 && $("#RecS_chart").length > 0 && $("#SumC_chart").length > 0) {
            //    $("#PayS_chart").highcharts().setSize(w1, h1, false);
            //    $("#RecS_chart").highcharts().setSize(w1, h1, false);
