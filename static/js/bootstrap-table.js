    ...
    BootstrapTable.prototype.initServer = function (silent, query, url) {
        ...
        request = $.extend({}, calculateObjectValue(null, this.options.ajaxOptions), {
            ...
            success: function (res) {
                /**TODO:2016-12-20�¼ӵĴ���,����ҳ��������⿪ʼ*/
                if (that.options.pagination && res.total && !res.rows.length) {//�ܼ�¼������0,����ǰҳ��¼��Ϊ0,���ʱҳ�볬�������ҳ����
                    that.options.pageNumber = Math.ceil(res.total / that.options.pageSize);//���һҳ(��ҳ��)
                    that.initServer();
                    return;
                }
                /**2016-12-20�¼ӵĴ���,����ҳ������������*/
